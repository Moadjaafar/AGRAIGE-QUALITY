                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GridView.count(
                              ...
                              children: [
                                _buildNumberField('Agraige A', _agraigeAController),
                                _buildNumberField('Agraige B', _agraigeBController),
                                _buildNumberField('Agraige C', _agraigeCController),
                                _buildNumberField('Agraige MAQ', _agraigeMAQController),
                                _buildNumberField('Agraige CHIN', _agraigeCHINController),
                                _buildNumberField('Agraige FP', _agraigeFPController),
                                _buildNumberField('Agraige G', _agraigeGController),
                                _buildNumberField('Agraige Anchois', _agraigeAnchoisController),
