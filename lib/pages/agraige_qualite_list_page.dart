        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('Agraige A', (test.agraigeA ?? 0).toString()),
              _buildDetailRow('Agraige B', (test.agraigeB ?? 0).toString()),
              _buildDetailRow('Agraige C', (test.agraigeC ?? 0).toString()),
              _buildDetailRow('Agraige MAQ', (test.agraigeMAQ ?? 0).toString()),
              _buildDetailRow('Agraige CHIN', (test.agraigeCHIN ?? 0).toString()),
              _buildDetailRow('Agraige FP', (test.agraigeFP ?? 0).toString()),
              _buildDetailRow('Agraige G', (test.agraigeG ?? 0).toString()),
              _buildDetailRow('Agraige Anchois', (test.agraigeAnchois ?? 0).toString()),
