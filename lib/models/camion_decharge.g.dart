...
CamionDecharge _$CamionDechargeFromJson(Map<String, dynamic> json) =>
    CamionDecharge(
      ...
      poidsUnitaireCarton: (json['poids_unitaire_carton'] as num?)?.toInt(),
...
Map<String, dynamic> _$CamionDechargeToJson(CamionDecharge instance) =>
    <String, dynamic>{
      ...
      'poids_unitaire_carton': instance.poidsUnitaireCarton,
